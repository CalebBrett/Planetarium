...
@app.route('/getNPlanets', methods=['POST'])
def getNPlanets():
...
@app.route('/get6Planets', methods=['GET'])
...
def genPlanet():
    ...
    velocity = rVel()
    return {"name": "Planet", "colour": str(hex), "radius":  radius,
                        "init_angle": initAngle, "orbital_radius": orbitalRadius,
